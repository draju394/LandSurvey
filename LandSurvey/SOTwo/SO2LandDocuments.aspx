<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SO2LandDocuments.aspx.cs" Inherits="LandSurvey.SOTwo.SO2LandDocuments" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding-top:20px" >
      ...
      <div class="col-lg-4" style="padding-top:5px" >
                   <asp:Button ID="btnViewMutation" runat="server" AutoPostBack="true" CssClass="btn btn-primary" Text="Mutation Search Report -HO" Width="200px" /> 
