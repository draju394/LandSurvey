...
{
    public partial class TitleSearch11 : System.Web.UI.Page
    {
        ...
        protected void cmbFamilyDocNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                lstBoxSurveyNo.Items.Clear();
                string selectedVillage = cmbVillage.SelectedValue.ToString().Trim();
                string SelectedDocNo = cmbFamilyDocNo.SelectedValue.ToString().Trim();
                dsFamilySurvey = dbfamilySurveyData.getFamilySurveyCmbNew(selectedVillage, SelectedDocNo);
        ...
        protected void lstBoxSurveyNo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //Show Grid Data 
                ShowGridHolderDataNew(selectedVillage, selectedDocNo, selectedSurveyNoMultiple);
                ...
                if (dsFamilyDetails.Tables[0].Rows.Count > 0)
                {
                  ...
                  ShowCheckListGrid(selectedVillage, cmbFamilyDocNo.SelectedValue.ToString().Trim());


                    //Select File Name from Document if Exist 

                    dsDocumentExitsIN = dbDocumentStatusData.DocumentExistIN(cmbVillage.SelectedValue.ToString().Trim(), cmbFamilyDocNo.SelectedValue.ToString().Trim(), selectedListItems());
        ...
        protected void ShowGridHolderDataNew(string selectedVillage, string selectDocNo, string selectedSurveyNoMultiple)
        {
            dsFamilyDetails = dbFamilyDetailsData.getFamilyDetailsMultipleSurvey(selectedVillage, selectDocNo, selectedSurveyNoMultiple);
            if (dsFamilyDetails.Tables[0].Rows.Count > 0)
            {
        ...
        protected void cmbFamily_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dsFamilyAreaStatus.Tables[0].Rows.Count == 1)
                {
                    ...
                    { lblStatus.Text = "Not Aquired"; } else { lblStatus.Text = "Aquired"; };
            ...
            if (FileUploadControl.HasFile)
            {
                ...
                try
                {
                    ...
                    if (validateCMB)
                    {
                        ...
                        string NewFileName = "MR_" + VillageCodeFolder + "_" + FamilyDocNo + "_" + registerFileNo + fileExtension;
            ...
            if (FileUploadControlDR.HasFile)
            {
                ...
                try
                {
                    ...
                    if (validateCMB)
                    {
                        ...
                        string FamilyDocNo = cmbFamilyDocNo.SelectedValue.ToString().Trim();
                        string NewFileName = "DR_" + VillageCodeFolder + "_" + FamilyDocNo + "_" + registerFileNo + fileExtension;
                        //  string NewFileName = "MR_" + VillageCodeFolder + "_" + FamilyNoName + "_" + registerFileNo + "." + fileExtension;
                        string folderName = Server.MapPath("~/Documents/" + VillageCodeFolder + "/");
                        if (!Directory.Exists(folderName))
                        {
            ...
            if (FileUploadControlPN.HasFile)
            {
                ...
                try
                {
                    ...
                    if (validateCMB)
                    {
                        ...
                        string VillageCodeFolder = cmbVillage.SelectedValue.ToString().Trim();
                        string FamilyDocNo = cmbFamilyDocNo.SelectedValue.ToString().Trim();
                        string NewFileName = "PN_" + VillageCodeFolder + "_" + FamilyDocNo + "_" + registerFileNo + fileExtension;
                        string folderName = Server.MapPath("~/Documents/" + VillageCodeFolder + "/");
                        if (!Directory.Exists(folderName))
                        {
                            Directory.CreateDirectory(folderName);
            ...
            if (FileUploadControlFR.HasFile)
            {
                ...
                try
                {
                    ...
                    if (validateCMB)
                    {
                        ...
                        string VillageCodeFolder = cmbVillage.SelectedValue.ToString().Trim();
                        string FamilyDocNo = cmbFamilyDocNo.SelectedValue.ToString().Trim();
                        string NewFileName = "FR_" + VillageCodeFolder + "_" + FamilyDocNo + "_" + registerFileNo + fileExtension;
                        string folderName = Server.MapPath("~/Documents/" + VillageCodeFolder + "/");
                        if (!Directory.Exists(folderName))
                        {
                            Directory.CreateDirectory(folderName);
        ...
        protected void grdHolderName_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            ShowGridHolderDataNew(cmbVillage.SelectedValue.ToString().Trim(), cmbFamilyDocNo.SelectedValue.ToString().Trim(), selectedListItems());
        ...
        protected void ShowCheckListGrid(string selectedVillage, string selectedDocNo)
        {
        ...
        protected void grdCheckList_RowEditing(object sender, GridViewEditEventArgs e)
        {
            ...
            ShowCheckListGrid(cmbVillage.SelectedValue.ToString().Trim(), cmbFamilyDocNo.SelectedValue.ToString().Trim());
        }

        protected void grdCheckList_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            Label ChkListNoID = grdCheckList.Rows[e.RowIndex].FindControl("lbl_IDChKList") as Label;
            TextBox HoRemark = grdCheckList.Rows[e.RowIndex].FindControl("txt_HORemark") as TextBox;
            dbChkListTranData.chklstno = Convert.ToInt32(ChkListNoID.Text.ToString());
