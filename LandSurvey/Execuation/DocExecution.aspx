<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocExecution.aspx.cs" Inherits="LandSurvey.Execuation.DocExecution" %>
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style6" colspan="5">
                    <asp:Label ID="Label6" runat="server" Text="Document Execution" Font-Bold="True" Font-Size="Medium"></asp:Label>
                </td>
                <td class="auto-style2"></td>
                <td class="auto-style2"></td>
            </tr>
                ...
                <td class="auto-style7" colspan="5">
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label4" runat="server" Text="Family Number :"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="cmbFamily" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbFamily_SelectedIndexChanged" Width="150px">
                                </asp:DropDownList>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList ID="cmbFamilyDocNo" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmbFamily_SelectedIndexChanged" Width="150px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="Label7" runat="server" Text="Family Total Area :"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="lblFamilyTotArea" runat="server" Text="FamilyTotalArea"></asp:Label>
                            </td>
                            <td>
                                <asp:Label ID="Label12" runat="server" Text="Document Status :"></asp:Label>
                            </td>
                            <td>
            ...
            <tr>
                ...
                <td class="auto-style7">
                    <asp:Button ID="btnSaveDocNo" runat="server" AutoPostBack="true" CssClass="btn btn-primary" OnClick="btnSaveDocNo_Click" Text="Save Document" Width="169px" xmlns:asp="#unknown" BackColor="#993333" BorderColor="#993333" />
                </td>
                <td class="auto-style7">
            ...
            <tr>
                ...
                <td class="auto-style7" colspan="5">
                    <table style="width:100%;">
                            ...
                            <td class="text-center" colspan="4">
                                <asp:GridView ID="grdCheckList" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" HorizontalAlign="Left" OnPageIndexChanging="grdHolderName_PageIndexChanging1" OnRowCancelingEdit="grdCheckList_RowCancelingEdit" OnRowEditing="grdCheckList_RowEditing" OnRowUpdating="grdCheckList_RowUpdating" PageSize="5" ShowHeaderWhenEmpty="True" Width="887px">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ID">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_IDChKList" runat="server" Text='<%#Eval("chklisttranno") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Sr. No">
                                            <ItemTemplate>
                                       ...
                                       <asp:TemplateField HeaderText="Documents / Findings">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_ChkListName" runat="server" Text='<%#Eval("chklistname") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Site Office Remark">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_SiteOfficeRemark" runat="server" Text='<%#Eval("siteofiiceremark") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <tr>
                            <td class="auto-style14">
                                <asp:Button ID="btnMutation0" runat="server" AutoPostBack="true" CssClass="btn btn-primary" OnClick="btnMutation_Click" Text="Agreement To Sale" Width="169px" xmlns:asp="#unknown" />
                            </td>
                            <td class="auto-style15">
                            ...
                            <td class="auto-style12">
                                <asp:Button ID="btnMRTemplate" runat="server" AutoPostBack="true" CssClass="btn btn-primary" OnClick="btnMRTemplate_Click" Text="Template" Width="169px" xmlns:asp="#unknown" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style14">
                                <asp:Button ID="btnRegistration" runat="server" CssClass="btn btn-primary" Text="Registered Sale Deed " Width="169px" OnClick="btnRegistration_Click" BackColor="#993333" />
                            </td>
                            <td class="auto-style15">
                            ...
                            <td class="auto-style12">
                                <asp:Button ID="btnDRTemplate" runat="server" AutoPostBack="true" CssClass="btn btn-primary" OnClick="btnDRTemplate_Click" Text="Template" Width="169px" xmlns:asp="#unknown" BackColor="#993333" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style9">
                                <asp:Button ID="btnPublicNotice" runat="server" CssClass="btn btn-primary" Text="Hami Patra" Width="169px" OnClick="btnPublicNotice_Click" BackColor="#CC00CC" />
                            </td>
                            ...
                            <td class="auto-style13">
                                <asp:Button ID="btnPNTemplate" runat="server" AutoPostBack="true" CssClass="btn btn-primary" OnClick="btnPNTemplate_Click" Text="Template" Width="169px" xmlns:asp="#unknown" BackColor="#CC00CC" />
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style14">
                                <asp:Button ID="btnFinalRemark" runat="server" CssClass="btn btn-primary" Text="Taba Pavti" Width="169px" OnClick="btnFinalRemark_Click" BackColor="#009933" />
                            </td>
                            <td class="auto-style15">
                            ...
                            <td class="auto-style12">
                                <asp:Button ID="btnFRTemplate" runat="server" AutoPostBack="true" CssClass="btn btn-primary" OnClick="btnFRTemplate_Click" Text="Template" Width="169px" xmlns:asp="#unknown" BackColor="#009933" />
                            </td>
                        </tr>
                    </table>
                </td>
