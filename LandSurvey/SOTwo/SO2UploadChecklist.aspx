<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SO2UploadChecklist.aspx.cs" Inherits="LandSurvey.SOTwo.SO2UploadChecklist" EnableEventValidation = "false" %>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
      ...
      <div class="col-md-4" style="padding-top:5px" >
          ...
          <asp:LinkButton ID="lblLinkChkList1" runat="server" OnClick="lblLinkChkList1_Click"  ></asp:LinkButton>
      </div>
...
<div class="upload" style="background-color:#f1c371;height:45px;padding-top: 5px; border-radius: 5px 5px 5px 5px;">
      ...
      <div class="col-lg-5" style="padding-top:5px" >
          <label for="" style="color:saddlebrown;font-size: 12px;">Uploaded Check List Other Documents:</label>
