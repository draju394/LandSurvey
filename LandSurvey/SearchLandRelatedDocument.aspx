<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SearchLandRelatedDocument.aspx.cs" Inherits="LandSurvey.SearchLandRelatedDocument" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">  
        function Validation() {
            ...
            if (Required('<%=txtKhataNo.ClientID%>', 'Khata No'))
                return true;
            return false;
        }
    </script>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <%--<asp:TextBox ID="txtKhataNo" MaxLength="10" runat="server" CssClass="form-control" Height="37px" Width="189px"></asp:TextBox>--%>

                <asp:TextBox ID="txtKhataNo"   runat="server" CssClass="form-control" Height="37px" Width="189px"></asp:TextBox>
            </div>
            <br />
            <div class="col-sm-4">
                <asp:Button ID="btnShow" runat="server" Text="Show" Height="28px" Width="75px" OnClick="btnShow_Click" />
                &nbsp;
        ...
        <div id="divtoPrint">
            <div id="divGrid" runat="server" visible="false">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <center><asp:Label ID="lblHeading"  Font-Bold="true" Font-Size="Medium" runat="server" Text="नमुना ८ अ"></asp:Label></center>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <asp:Label ID="lblKhataNo" runat="server" Text="खाते क्र : "></asp:Label>
                        <asp:Label ID="lblKhataNoValue" runat="server" Text=""></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label ID="lblKhataType" runat="server" Text="खाते प्रकार : "></asp:Label>
                        <asp:Label ID="lblKhataTypeValue" runat="server" Text=""></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <asp:Label ID="lblKhatedarNamem" runat="server" Text="खातेदारांची नावे : "></asp:Label>
                        <asp:Label ID="lblKhatedarValue" runat="server" Text=""></asp:Label>
                ...
                <asp:GridView ID="grdLandRelatedDoc" runat="server" AllowPaging="false" PageSize="5" Width="988px"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="holderarea" HeaderText="खातेदाराचे  क्षेत्र" />
