<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HODocExecution.aspx.cs" Inherits="LandSurvey.HO.HODocExecution" %>
 ...
 <asp:Panel ID="PanelAllUploadDoc" runat="server" >
    ...
    <br />
     <%-- Start PN --%>
      <div class="upload" style="background-color:#f1c371;height:45px;padding-top: 5px; border-radius: 5px 5px 5px 5px;">
        <div class="col-md-3" >
           <asp:Button ID="btnPN" runat="server" AutoPostBack="true" CssClass="btn btn-primary" Text="Public Notice" Width="270px" xmlns:asp="#unknown" OnClick="btnPN_Click" />
        </div> 
        <div class="col-lg-3" style="padding-top:5px">
          <asp:FileUpload ID="FileUploadPN" runat="server" Height="30px" Width="208px" />
        </div>
      <div class="col-lg-5" style="padding-top:5px" >
          <label for="" style="color:saddlebrown;font-size: 12px;">Uploaded Public Notice:</label>
