<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SOIndex2.aspx.cs" Inherits="LandSurvey.User.SOIndex2" %>
    ...
    .smallcard {
     ...
     <div id="SiteOffice2">
        ...
        <div class="row" style="background-color:#f1c371;height:47px;padding-top: 10px; border-radius: 5px 5px 5px 5px;">
            <div class="col-md-8">
                <label for="" style="color:saddlebrown;font-size: 18px;">Site Office - Registry Search Team</label>
        ...
        <div class="row" style="padding-top:20px;">
            <div class="column">
                <div class="card smallcard" style="background:#556b8d;/*background:linear-gradient(45deg,#4099ff,#73b4ff);background:linear-gradient(-45deg,#f403d1,#64b5f6);*/">
                    <table>
                        <tr>
                            <td onclick="document.location='/SOOne/SO1LandDocument'" runat="server" style="cursor:hand"> <img src="../Images/DocPlan2.png" width="80" height="85" /></td>
                            <td style="text-align:right;">
                                
                               <%-- @*<h4 style="color:white;font:bold">@ViewBag.DataTotal</h4>*@--%>
                                <label for="" style="color: white;font-size: 18px;" id="TotalVoterId"></label>
                                <h4 style="color:white">Land Releated Documents</h4>
            ...
            <div class="column"> 
                <div class="card smallcard" style="background:#85c744">
                    <table class="tableshow">
                        <tr>
                            <td onclick="document.location='/SOTwo/SO2UploadDocuments'" runat="server" style="cursor:hand; vertical-align:top">
                                <img src="../Images/DocReceived.png" width="80" height="85" /></td>
                            <td style="text-align:left; align-items:center">
                                
                               <%-- @*<h4 style="color:white;font:bold">@ViewBag.DataTotal</h4>*@--%>
                                <label for="" style="color: white;font-size: 18px;" id="TotalVoterId"></label>
                                <h4 style="color:white"> Registry Search Documents</h4>
            ...
            <%--<div class="column">
                <div class="card smallcard" style="background:#602f3d;/*background:linear-gradient(45deg,#FFB64D,#ffcb80);background:linear-gradient(to bottom, #33ccff 0%, #0066cc 100%);*/">
                    <table>
                        <tr>
                            <td onclick="document.location='/SOTwo/SO2UploadChecklist'" runat="server" style="cursor:hand; vertical-align:top">
                                <img src="../Images/DocSearch2.png" width="80" height="85" /></td>
                            <td style="text-align:left; align-items:center">
                                
                             
                                <label for="" style="color: white;font-size: 18px;" id="TotalVoterId"></label>
                                <h4 style="color:white"> Registry Search Checklist</h4>
            ...
            <div class="column">
                <div class="card smallcard" style="background: #e74c3c;/*background:linear-gradient(45deg,#FF5370,#ff869a);background:linear-gradient(to bottom, #ffcc00 0%, #ffffcc 100%);*/">
                    <table>
                        <tr>
                           <td onclick="document.location='/SOTwo/SO2DocExecution2'" runat="server" style="cursor:hand; vertical-align:top">
