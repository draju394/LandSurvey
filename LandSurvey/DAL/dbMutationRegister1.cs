...
{
    public class dbMutationRegister1 : dbConnection
    {
        ...
        public DataSet getMutationRegisterData(string MutationNo, string VillageCode)
        {
            try
            {
                ...
                {
                    strQuery = " and mr.mutationno = '" + MutationNo + "' and mr.villagecode = '" + VillageCode + "'";
                }
                ...
                ds = FillData("select row_number() over() as srno, mr.mutationid, mr.villagecode, v.villagemname, mr.mutationno, mr.mutationyear, mr.mutationdetail, mr.mutremarks," +
                               "mr.csurveyno as surveynos from mutationregister mr join village v on mr.villagecode = v.villagecode where COALESCE(mr.field4,'0') = '0' and COALESCE(mr.field5,'0') = '0' " + strQuery, "MutationRegister");
            }
            catch (Exception ex)
            {
                throw ex;
