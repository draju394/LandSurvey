<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SolicitorIndex.aspx.cs" Inherits="LandSurvey.User.SolicitorIndex" %>
    ...
    .smallcard {
     ...
     <div id="Solicitor">
        ...
        <div class="row" style="background-color:#f1c371;height:47px;padding-top: 10px; border-radius: 5px 5px 5px 5px;">
            <div class="col-md-2">
                <label for="" style="color:saddlebrown;font-size: 18px;">Solicitor Approval</label>
        ...
        <div class="row" style="padding-top:20px;">
            <div class="column">
                <div class="card smallcard" style="background:#556b8d;/*background:linear-gradient(45deg,#4099ff,#73b4ff);background:linear-gradient(-45deg,#f403d1,#64b5f6);*/">
                    <table>
                        <tr>
                           <%-- <td onclick="document.location='/Solicitor/SolicitorApproval'" runat="server" style="cursor:hand"> <img src="../Images/DocPlan2.png" width="80" height="85" /></td>--%>
                             <td onclick="document.location='/Solicitor/SolicitorApprovalList'" runat="server" style="cursor:hand"> <img src="../Images/DocPlan2.png" width="80" height="85" /></td>
                            <td style="text-align:right;">
                                
                               <%-- @*<h4 style="color:white;font:bold">@ViewBag.DataTotal</h4>*@--%>
                                <label for="" style="color: white;font-size: 18px;" id="TotalVoterId"></label>
                                <h4 style="color:white">Document Scrutiny and Approval</h4>
            ...
            <div class="column"> 
                <div class="card smallcard" style="background:#85c744">
                    <table class="tableshow">
                        <tr>
                            <td onclick="document.location='/comingsoon'" runat="server" style="cursor:hand; vertical-align:top">
