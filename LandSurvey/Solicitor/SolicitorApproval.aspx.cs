...
{
    public partial class SolicitorApproval : System.Web.UI.Page
    {
        // public string filePath = Convert.ToString(ConfigurationManager.AppSettings["UploadFilePath"]);

        //public string filePath = Server.MapPath("~/Documents/");
        ...
        protected void cmdDocumentNumber_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                table.Rows.Add(3, "Upload Queries-PTS", "", "", "", "PTS", "query", "", "", "UQPTS", "1", "", "", "");
                table.Rows.Add(4, "Clarification Documents from H.O.-PTSQ", "", "", "", "ODHO", "download", "", "", "ODHO", "1", "", "", "");
                table.Rows.Add(5, "Approval for Public Notice", "", "", "", "PN", "approval", "", "", "PN", "1", "", "", "");

                table.Rows.Add(6, "Public Notice Inputs", "", "", "", "PN", "query", "", "", "RPN", "1", "", "", "");
                table.Rows.Add(7, "Clarification Documents From H.O.–PN", "", "", "", "PN", "download", "", "", "HOPN", "1", "", "", "");
                table.Rows.Add(8, "Final Title Search Document", "", "", "", "FTS", "download", "", "", "FTS", "1", "", "", "");

                table.Rows.Add(9, "Accept Final Search Document", "", "", "", "FTS", "approval", "", "", "FTS", "1", "", "", "");
                table.Rows.Add(10, "Upload Queries-FTS", "", "", "", "FTS", "query", "", "", "UQFTS", "1", "", "", "");
                table.Rows.Add(11, "Clarification Documents From H.O.-FTS,", "", "", "", "FTS", "download", "", "", "HOFTS", "1", "", "", "");

                table.Rows.Add(12, "Sale Deed", "", "", "", "SD", "download", "", "", "SD", "1", "", "", "");
                table.Rows.Add(13, "Accept Sale Deed", "", "", "", "SD", "approval", "", "", "SD", "1", "", "", "");
                table.Rows.Add(14, "Upload Queries-SD", "", "", "", "SD", "query", "", "", "UQSD", "1", "", "", "");

                table.Rows.Add(15, "Agreement to Sale", "", "", "", "ATS", "download", "", "", "ATS", "1", "", "", "");
                table.Rows.Add(16, "Accept Agreement to Sale", "", "", "", "ATS", "approval", "", "", "ATS", "1", "", "", "");
                table.Rows.Add(17, "Upload Queries-ATS", "", "", "", "ATS", "query", "", "", "UQATS", "1", "", "", "");
                ...
                if (dsDocument != null && dsDocument.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dsDocument.Tables[0].Select())
                    {
                        ...
                        //  docPath =  Server.MapPath(@"~/Documents/" + cmbVillage.SelectedValue.ToString() + "/" + docName);
