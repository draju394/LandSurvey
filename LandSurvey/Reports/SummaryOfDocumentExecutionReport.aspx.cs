...
{
    public partial class SummaryOfDocumentExecutionReport : System.Web.UI.Page
    {
        ...
        protected void SummaryGridBind(string VillageCode)
        {
            ...
            dsSummary = dbReportsData.getSummaryOfDocumentExecutionReport(VillageCode);
        ...
        protected void Grid1_ServerPdfExporting(object sender, GridEventArgs e)
        {
            ...
            if (dsSummary.Tables[0].Rows.Count > 0)
            {
                ...
                PdfDocument pdfDocument = exp.Export(Grid1.Model, (IEnumerable)list, "SummaryOfDocumentExecutionReport.pdf", true, true, "flat-lime", true);
                ...
                PdfCompositeField compositeField1 = new PdfCompositeField(font, brush, "Summary Of Document Execution Report");
                ...
                pdfDocument.Save("SummaryOfDocumentExecutionReport.pdf", Response, HttpReadType.Save);
